...
TEST(AgradRevMatrix, fill_0) {
  ...
  double a = 15;
  fill(z, a);
  EXPECT_DOUBLE_EQ(15.0, z[0]);
  EXPECT_DOUBLE_EQ(15.0, z[1]);
  EXPECT_EQ(2U, z.size());
