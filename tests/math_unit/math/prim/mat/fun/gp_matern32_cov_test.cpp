...
TEST(MathPrimMat, domain_err_training_sig_l_gamma_0) {
  double sigma = .2;
  double l = 7;
...
TEST(MathPrimMat, nan_error_training_sig_l_gamma_0) {
  double sigma = 0.2;
  double l = 5;
...
TEST(MathPrimMat, calculations_1) {
  double sigma = 1.0;
  double l = 1.0;
...
TEST(MathPrimMat, calculations_ard_1) {
  double sigma = 1.0;
