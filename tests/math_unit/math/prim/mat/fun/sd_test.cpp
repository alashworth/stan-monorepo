...
TEST(MathMatrix, sd) {
  ...
  x.push_back(1.0);
  EXPECT_DOUBLE_EQ(0.0, sd(x));
  x.push_back(2.0);
  EXPECT_NEAR(0.7071068, sd(x), 0.000001);
  x.push_back(3.0);
  EXPECT_DOUBLE_EQ(1.0, sd(x));
