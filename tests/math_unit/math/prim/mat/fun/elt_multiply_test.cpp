...
TEST(MathMatrix, eltMultiplyVec) {
  ...
  EXPECT_DOUBLE_EQ(10.0, v(0));
  EXPECT_DOUBLE_EQ(200.0, v(1));
}
...
TEST(MathMatrix, eltMultiplyMatrix) {
  ...
  EXPECT_DOUBLE_EQ(200.0, m(0, 1));
  EXPECT_DOUBLE_EQ(3000.0, m(0, 2));
  EXPECT_DOUBLE_EQ(40000.0, m(1, 0));
  EXPECT_DOUBLE_EQ(500000.0, m(1, 1));
  EXPECT_DOUBLE_EQ(6000000.0, m(1, 2));
}
