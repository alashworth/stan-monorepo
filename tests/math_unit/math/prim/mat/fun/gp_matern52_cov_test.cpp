...
TEST(MathPrimMat, vec_double_gp_matern52_cov1_0) {
  double sigma = 0.2;
  double l = 5.0;
...
TEST(MathPrimMat, domain_err_training_sig_l_gamma_1) {
  double sigma = .2;
  double l = 7;
...
TEST(MathPrimMat, nan_error_training_sig_l_gamma_1) {
  double sigma = 0.2;
  double l = 5;
