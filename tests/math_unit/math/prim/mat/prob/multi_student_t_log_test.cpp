...
TEST(ProbMultiStudentT, log_matches_lpmf) {
  ...
  double nu = 4.0;
  EXPECT_DOUBLE_EQ((stan::math::multi_student_t_lpdf(y, nu, mu, Sigma)),
                   (stan::math::multi_student_t_log(y, nu, mu, Sigma)));
  EXPECT_DOUBLE_EQ((stan::math::multi_student_t_lpdf<true>(y, nu, mu, Sigma)),
                   (stan::math::multi_student_t_log<true>(y, nu, mu, Sigma)));
  EXPECT_DOUBLE_EQ((stan::math::multi_student_t_lpdf<false>(y, nu, mu, Sigma)),
