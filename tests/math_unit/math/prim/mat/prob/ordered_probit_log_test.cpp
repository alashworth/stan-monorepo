...
TEST(ProbOrderedProbit, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::ordered_probit_lpmf(3, lambda, c)),
                   (stan::math::ordered_probit_log(3, lambda, c)));
  EXPECT_DOUBLE_EQ((stan::math::ordered_probit_lpmf<true>(3, lambda, c)),
                   (stan::math::ordered_probit_log<true>(3, lambda, c)));
  EXPECT_DOUBLE_EQ((stan::math::ordered_probit_lpmf<false>(3, lambda, c)),
