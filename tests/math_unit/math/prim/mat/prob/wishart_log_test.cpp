...
TEST(ProbWishart, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::wishart_lpdf(Y, dof, Sigma)),
                   (stan::math::wishart_log(Y, dof, Sigma)));
  EXPECT_DOUBLE_EQ((stan::math::wishart_lpdf<true>(Y, dof, Sigma)),
                   (stan::math::wishart_log<true>(Y, dof, Sigma)));
  EXPECT_DOUBLE_EQ((stan::math::wishart_lpdf<false>(Y, dof, Sigma)),
