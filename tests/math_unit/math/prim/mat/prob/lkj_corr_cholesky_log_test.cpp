...
TEST(ProbLkjCorrCholesky, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::lkj_corr_cholesky_lpdf(Sigma, eta)),
                   (stan::math::lkj_corr_cholesky_log(Sigma, eta)));
  EXPECT_DOUBLE_EQ((stan::math::lkj_corr_cholesky_lpdf<true>(Sigma, eta)),
                   (stan::math::lkj_corr_cholesky_log<true>(Sigma, eta)));
  EXPECT_DOUBLE_EQ((stan::math::lkj_corr_cholesky_lpdf<false>(Sigma, eta)),
