...
TEST(ProbMultiGp, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::multi_gp_lpdf(y, Sigma, w)),
                   (stan::math::multi_gp_log(y, Sigma, w)));
  EXPECT_DOUBLE_EQ((stan::math::multi_gp_lpdf<true>(y, Sigma, w)),
                   (stan::math::multi_gp_log<true>(y, Sigma, w)));
  EXPECT_DOUBLE_EQ((stan::math::multi_gp_lpdf<false>(y, Sigma, w)),
