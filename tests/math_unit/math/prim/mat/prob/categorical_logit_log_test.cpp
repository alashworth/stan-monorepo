...
TEST(ProbCategoricalLogit, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf<true, double>(1, theta)),
  ...
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf<double>(1, theta)),
                   (stan::math::categorical_logit_log<double>(1, theta)));
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf(1, theta)),
                   (stan::math::categorical_logit_log(1, theta)));
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf<true>(1, theta)),
                   (stan::math::categorical_logit_log<true>(1, theta)));
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf<false>(1, theta)),
  ...
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf<double>(ns, theta)),
                   (stan::math::categorical_logit_log<double>(ns, theta)));
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf(ns, theta)),
                   (stan::math::categorical_logit_log(ns, theta)));
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf<true>(ns, theta)),
                   (stan::math::categorical_logit_log<true>(ns, theta)));
  EXPECT_DOUBLE_EQ((stan::math::categorical_logit_lpmf<false>(ns, theta)),
