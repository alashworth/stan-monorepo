...
TEST(ProbDistributionsMultiStudentT, Vectorized) {
  ...
  // y and mu vectorized
  EXPECT_FLOAT_EQ(-15.747059326400798,
  ...
  EXPECT_FLOAT_EQ(-15.747059326400798, stan::math::multi_student_t_log(
                                           vec_y_t, nu, vec_mu_t, Sigma));

  // y vectorized
  EXPECT_FLOAT_EQ(-15.985443164278658,
  ...
  // mu vectorized
  EXPECT_FLOAT_EQ(-12.346401517300393,
