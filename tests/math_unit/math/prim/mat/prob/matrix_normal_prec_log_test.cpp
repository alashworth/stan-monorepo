...
TEST(ProbMatrixNormalPrec, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::matrix_normal_prec_lpdf(y, mu, D, Sigma)),
                   (stan::math::matrix_normal_prec_log(y, mu, D, Sigma)));
  EXPECT_DOUBLE_EQ((stan::math::matrix_normal_prec_lpdf<true>(y, mu, D, Sigma)),
  ...
  EXPECT_DOUBLE_EQ(
      ...
      (stan::math::matrix_normal_prec_log<false, double, double, double>(
          y, mu, D, Sigma)));
  EXPECT_DOUBLE_EQ((stan::math::matrix_normal_prec_lpdf<double, double, double>(
                       y, mu, D, Sigma)),
