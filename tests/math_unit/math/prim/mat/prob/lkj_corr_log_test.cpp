...
TEST(ProbLkjCorr, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::lkj_corr_lpdf(Sigma, eta)),
                   (stan::math::lkj_corr_log(Sigma, eta)));
  EXPECT_DOUBLE_EQ((stan::math::lkj_corr_lpdf<true>(Sigma, eta)),
                   (stan::math::lkj_corr_log<true>(Sigma, eta)));
  EXPECT_DOUBLE_EQ((stan::math::lkj_corr_lpdf<false>(Sigma, eta)),
