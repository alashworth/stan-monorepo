...
TEST(ProbMultiNormal, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::multi_normal_lpdf(y, mu, Sigma)),
                   (stan::math::multi_normal_log(y, mu, Sigma)));
  EXPECT_DOUBLE_EQ((stan::math::multi_normal_lpdf<true>(y, mu, Sigma)),
                   (stan::math::multi_normal_log<true>(y, mu, Sigma)));
  EXPECT_DOUBLE_EQ((stan::math::multi_normal_lpdf<false>(y, mu, Sigma)),
