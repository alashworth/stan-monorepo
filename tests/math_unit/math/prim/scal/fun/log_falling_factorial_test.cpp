...
TEST(MathFunctions, log_falling_factorial) {
  ...
  EXPECT_DOUBLE_EQ(std::log(24), log_falling_factorial(4.0, 3));
  EXPECT_DOUBLE_EQ(std::log(120), log_falling_factorial(5.0, 4));
  EXPECT_DOUBLE_EQ(std::log(144.8261), log_falling_factorial(6.1, 3.1));
