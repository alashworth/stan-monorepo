...
TEST(MathFunctions, lbeta) {
  ...
  EXPECT_DOUBLE_EQ(0.0, lbeta(1.0, 1.0));
  EXPECT_DOUBLE_EQ(2.981361, lbeta(0.1, 0.1));
  EXPECT_DOUBLE_EQ(-4.094345, lbeta(3.0, 4.0));
  EXPECT_DOUBLE_EQ(-4.094345, lbeta(4.0, 3.0));
}
