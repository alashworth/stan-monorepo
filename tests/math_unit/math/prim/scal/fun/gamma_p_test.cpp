...
TEST(MathFunctions, gamma_p) {
  ...
  EXPECT_DOUBLE_EQ(0.63212055, gamma_p(1.0, 1.0));
  EXPECT_DOUBLE_EQ(0.82755178, gamma_p(0.1, 0.1));
  EXPECT_DOUBLE_EQ(0.76189667, gamma_p(3.0, 4.0));
  EXPECT_DOUBLE_EQ(0.35276812, gamma_p(4.0, 3.0));
