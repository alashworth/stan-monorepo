...
TEST(ProbDoubleExponential, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::double_exponential_lpdf(y, mu, sigma)),
                   (stan::math::double_exponential_log(y, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::double_exponential_lpdf<true>(y, mu, sigma)),
                   (stan::math::double_exponential_log<true>(y, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::double_exponential_lpdf<false>(y, mu, sigma)),
  ...
  EXPECT_DOUBLE_EQ(
      ...
      (stan::math::double_exponential_log<false, double, double, double>(
          y, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::double_exponential_lpdf<double, double, double>(
                       y, mu, sigma)),
