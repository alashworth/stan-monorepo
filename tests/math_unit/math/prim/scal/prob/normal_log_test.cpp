...
TEST(ProbNormal, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::normal_lpdf(y, mu, sigma)),
                   (stan::math::normal_log(y, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::normal_lpdf<true>(y, mu, sigma)),
                   (stan::math::normal_log<true>(y, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::normal_lpdf<false>(y, mu, sigma)),
