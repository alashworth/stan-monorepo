...
TEST(ProbVonMises, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::von_mises_lpdf(y, mu, kappa)),
                   (stan::math::von_mises_log(y, mu, kappa)));
  EXPECT_DOUBLE_EQ((stan::math::von_mises_lpdf<true>(y, mu, kappa)),
                   (stan::math::von_mises_log<true>(y, mu, kappa)));
  EXPECT_DOUBLE_EQ((stan::math::von_mises_lpdf<false>(y, mu, kappa)),
