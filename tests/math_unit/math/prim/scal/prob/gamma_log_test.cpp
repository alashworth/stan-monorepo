...
TEST(ProbGamma, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::gamma_lpdf(y, alpha, beta)),
                   (stan::math::gamma_log(y, alpha, beta)));
  EXPECT_DOUBLE_EQ((stan::math::gamma_lpdf<true>(y, alpha, beta)),
                   (stan::math::gamma_log<true>(y, alpha, beta)));
  EXPECT_DOUBLE_EQ((stan::math::gamma_lpdf<false>(y, alpha, beta)),
