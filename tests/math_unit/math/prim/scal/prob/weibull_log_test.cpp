...
TEST(ProbWeibull, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::weibull_lpdf(y, alpha, sigma)),
                   (stan::math::weibull_log(y, alpha, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::weibull_lpdf<true>(y, alpha, sigma)),
                   (stan::math::weibull_log<true>(y, alpha, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::weibull_lpdf<false>(y, alpha, sigma)),
  ...
  EXPECT_DOUBLE_EQ((stan::math::weibull_lpdf<false, double, double, double>(
                       y, alpha, sigma)),
