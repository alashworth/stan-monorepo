...
TEST(ProbExponential, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::exponential_lpdf(y, beta)),
                   (stan::math::exponential_log(y, beta)));
  EXPECT_DOUBLE_EQ((stan::math::exponential_lpdf<true>(y, beta)),
                   (stan::math::exponential_log<true>(y, beta)));
  EXPECT_DOUBLE_EQ((stan::math::exponential_lpdf<false>(y, beta)),
  ...
  EXPECT_DOUBLE_EQ((stan::math::exponential_lpdf<double, double>(y, beta)),
