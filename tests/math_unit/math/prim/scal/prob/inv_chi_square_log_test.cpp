...
TEST(ProbInvChiSquare, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::inv_chi_square_lpdf(y, nu)),
                   (stan::math::inv_chi_square_log(y, nu)));
  EXPECT_DOUBLE_EQ((stan::math::inv_chi_square_lpdf<true>(y, nu)),
                   (stan::math::inv_chi_square_log<true>(y, nu)));
  EXPECT_DOUBLE_EQ((stan::math::inv_chi_square_lpdf<false>(y, nu)),
  ...
  EXPECT_DOUBLE_EQ((stan::math::inv_chi_square_lpdf<double, double>(y, nu)),
