...
TEST(ProbBetaProportion, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::beta_proportion_lpdf(y, mu, kappa)),
                   (stan::math::beta_proportion_log(y, mu, kappa)));
  EXPECT_DOUBLE_EQ((stan::math::beta_proportion_lpdf<true>(y, mu, kappa)),
                   (stan::math::beta_proportion_log<true>(y, mu, kappa)));
  EXPECT_DOUBLE_EQ((stan::math::beta_proportion_lpdf<false>(y, mu, kappa)),
