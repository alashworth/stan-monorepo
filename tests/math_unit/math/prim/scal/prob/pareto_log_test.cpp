...
TEST(ProbPareto, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::pareto_lpdf(y, y_min, alpha)),
                   (stan::math::pareto_log(y, y_min, alpha)));
  EXPECT_DOUBLE_EQ((stan::math::pareto_lpdf<true>(y, y_min, alpha)),
                   (stan::math::pareto_log<true>(y, y_min, alpha)));
  EXPECT_DOUBLE_EQ((stan::math::pareto_lpdf<false>(y, y_min, alpha)),
