...
TEST(ProbDistributionsNegBinomial, error_check_1) {
...
TEST(ProbDistributionsNegBinomial, chiSquareGoodnessFitTest_1) {
  boost::random::mt19937 rng;
  int N = 1000;
...
TEST(ProbDistributionsNegBinomial, chiSquareGoodnessFitTest2_1) {
  boost::random::mt19937 rng;
  int N = 1000;
  int K = stan::math::round(2 * std::pow(N, 0.4));
...
TEST(ProbDistributionsNegBinomial, chiSquareGoodnessFitTest3_1) {
  boost::random::mt19937 rng;
  int N = 1000;
  int K = stan::math::round(2 * std::pow(N, 0.4));
