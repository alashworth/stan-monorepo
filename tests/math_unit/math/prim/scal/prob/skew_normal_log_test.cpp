...
TEST(ProbSkewNormal, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::skew_normal_lpdf(y, mu, sigma, alpha)),
                   (stan::math::skew_normal_log(y, mu, sigma, alpha)));
  EXPECT_DOUBLE_EQ((stan::math::skew_normal_lpdf<true>(y, mu, sigma, alpha)),
                   (stan::math::skew_normal_log<true>(y, mu, sigma, alpha)));
  EXPECT_DOUBLE_EQ((stan::math::skew_normal_lpdf<false>(y, mu, sigma, alpha)),
