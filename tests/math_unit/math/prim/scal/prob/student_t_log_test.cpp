...
TEST(ProbStudentT, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::student_t_lpdf(y, nu, mu, sigma)),
                   (stan::math::student_t_log(y, nu, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::student_t_lpdf<true>(y, nu, mu, sigma)),
                   (stan::math::student_t_log<true>(y, nu, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::student_t_lpdf<false>(y, nu, mu, sigma)),
  ...
  EXPECT_DOUBLE_EQ(
      ...
      (stan::math::student_t_log<false, double, double, double, double>(
          y, nu, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::student_t_lpdf<double, double, double, double>(
                       y, nu, mu, sigma)),
