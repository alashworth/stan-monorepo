...
TEST(ProbNegBinomial, log_matches_lpmf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::neg_binomial_lpmf(y, alpha, beta)),
                   (stan::math::neg_binomial_log(y, alpha, beta)));
  EXPECT_DOUBLE_EQ((stan::math::neg_binomial_lpmf<true>(y, alpha, beta)),
                   (stan::math::neg_binomial_log<true>(y, alpha, beta)));
  EXPECT_DOUBLE_EQ((stan::math::neg_binomial_lpmf<false>(y, alpha, beta)),
                   (stan::math::neg_binomial_log<false>(y, alpha, beta)));
  EXPECT_DOUBLE_EQ((stan::math::neg_binomial_lpmf<true, int, double, double>(
                       y, alpha, beta)),
                  (stan::math::neg_binomial_log<true, int, double, double>(
                      y, alpha, beta)));
  EXPECT_DOUBLE_EQ((stan::math::neg_binomial_lpmf<false, int, double, double>(
                       y, alpha, beta)),
