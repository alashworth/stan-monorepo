...
TEST(ProbLognormal, log_matches_lpdf) {
  ...
  EXPECT_DOUBLE_EQ((stan::math::lognormal_lpdf(y, mu, sigma)),
                   (stan::math::lognormal_log(y, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::lognormal_lpdf<true>(y, mu, sigma)),
                   (stan::math::lognormal_log<true>(y, mu, sigma)));
  EXPECT_DOUBLE_EQ((stan::math::lognormal_lpdf<false>(y, mu, sigma)),
