...
TEST(AgradRevMatrix, add_scalar) {
  ...
  result = add(2.0, v);
  EXPECT_DOUBLE_EQ(3.0, result(0, 0).val());
  EXPECT_DOUBLE_EQ(4.0, result(0, 1).val());
  EXPECT_DOUBLE_EQ(5.0, result(1, 0).val());
  EXPECT_DOUBLE_EQ(6.0, result(1, 1).val());
...
TEST(AgradRevMatrix, add_vector_vector) {
  ...
  EXPECT_DOUBLE_EQ(expected_output(0), output_v(0).val());
  EXPECT_DOUBLE_EQ(expected_output(1), output_v(1).val());
  EXPECT_DOUBLE_EQ(expected_output(2), output_v(2).val());
  EXPECT_DOUBLE_EQ(expected_output(3), output_v(3).val());
  EXPECT_DOUBLE_EQ(expected_output(4), output_v(4).val());
...
TEST(AgradRevMatrix, add_matrix_matrix) {
  ...
  EXPECT_DOUBLE_EQ(expected_output(0, 0), output_v(0, 0).val());
  EXPECT_DOUBLE_EQ(expected_output(0, 1), output_v(0, 1).val());
  EXPECT_DOUBLE_EQ(expected_output(1, 0), output_v(1, 0).val());
  EXPECT_DOUBLE_EQ(expected_output(1, 1), output_v(1, 1).val());
...
TEST(AgradRevMatrix, check_varis_on_stack_102) {
