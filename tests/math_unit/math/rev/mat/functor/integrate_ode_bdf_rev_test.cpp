...
#include <math/rev/mat/functor/util_cvodes_bdf.hpp>
...
TEST(StanAgradRevOde_integrate_ode, harmonic_oscillator_finite_diff_1) {
...
TEST(StanAgradRevOde_integrate_ode, harmonic_oscillator_error_1) {
  using stan::math::var;
