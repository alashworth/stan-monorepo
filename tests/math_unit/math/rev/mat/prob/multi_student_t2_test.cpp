...
#include <math/rev/mat/prob/test_gradients_multi_student_t.hpp>
#include <math/prim/mat/prob/agrad_distributions_multi_student_t.hpp>
...
TEST(MultiNormal, check_varis_on_stack_304) {
  double nu(5);
