...
TEST(AgradRev, if_else) {
  ...
  EXPECT_DOUBLE_EQ(1.0, if_else(true, var(1.0), var(2.0)).val());
  EXPECT_DOUBLE_EQ(2.0, if_else(false, var(1.0), var(2.0)).val());

  EXPECT_DOUBLE_EQ(1.0, if_else(true, 1.0, var(2.0)).val());
  EXPECT_DOUBLE_EQ(2.0, if_else(false, 1.0, var(2.0)).val());

  EXPECT_DOUBLE_EQ(1.0, if_else(true, var(1.0), 2.0).val());
  EXPECT_DOUBLE_EQ(2.0, if_else(false, var(1.0), 2.0).val());
}
...
TEST(AgradRev, if_else_nan) {
  ...
  EXPECT_DOUBLE_EQ(1.2, if_else(true, 1.2, nan_v).val());
  EXPECT_DOUBLE_EQ(1.2, if_else(true, a_v, nan).val());
  EXPECT_DOUBLE_EQ(1.2, if_else(true, a_v, nan_v).val());
  ...
  a_v = 2.4;
  EXPECT_DOUBLE_EQ(2.4, if_else(false, nan_v, 2.4).val());
  EXPECT_DOUBLE_EQ(2.4, if_else(false, nan, a_v).val());
  EXPECT_DOUBLE_EQ(2.4, if_else(false, nan_v, a_v).val());
