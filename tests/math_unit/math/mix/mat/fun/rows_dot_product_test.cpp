...
TEST(AgradMixMatrixRowsDotProduct, fv_vector_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(-6, output(1).val_.val());
  EXPECT_DOUBLE_EQ(5, output(2).val_.val());
  EXPECT_DOUBLE_EQ(5, output(0).d_.val());
  EXPECT_DOUBLE_EQ(1, output(1).d_.val());
  EXPECT_DOUBLE_EQ(-6, output(2).d_.val());
...
TEST(AgradMixMatrixRowsDotProduct, ffv_vector_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(-6, output(1).val_.val().val());
  EXPECT_DOUBLE_EQ(5, output(2).val_.val().val());
  EXPECT_DOUBLE_EQ(5, output(0).d_.val().val());
  EXPECT_DOUBLE_EQ(1, output(1).d_.val().val());
  EXPECT_DOUBLE_EQ(-6, output(2).d_.val().val());
