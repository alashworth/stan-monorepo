...
TEST(AgradMixMatrixTraceQuadForm, mat_fv_1st_deriv) {
  ...
  EXPECT_DOUBLE_EQ(16126, res.d_.val());
...
TEST(AgradMixMatrixTraceQuadForm, mat_fv_2nd_deriv) {
  ...
  VEC h;
  res.d_.grad(z, h);
  EXPECT_DOUBLE_EQ(220, h[0]);
  EXPECT_DOUBLE_EQ(111, h[1]);
  EXPECT_DOUBLE_EQ(104, h[2]);
  EXPECT_DOUBLE_EQ(117, h[3]);
  EXPECT_DOUBLE_EQ(111, h[4]);
  EXPECT_DOUBLE_EQ(2, h[5]);
  EXPECT_DOUBLE_EQ(-5, h[6]);
  EXPECT_DOUBLE_EQ(8, h[7]);
  EXPECT_DOUBLE_EQ(104, h[8]);
  EXPECT_DOUBLE_EQ(-5, h[9]);
  EXPECT_DOUBLE_EQ(-12, h[10]);
  EXPECT_DOUBLE_EQ(1, h[11]);
  EXPECT_DOUBLE_EQ(117, h[12]);
  EXPECT_DOUBLE_EQ(8, h[13]);
  EXPECT_DOUBLE_EQ(1, h[14]);
  EXPECT_DOUBLE_EQ(14, h[15]);
  EXPECT_DOUBLE_EQ(241, h[16]);
  EXPECT_DOUBLE_EQ(57, h[17]);
  EXPECT_DOUBLE_EQ(241, h[18]);
  EXPECT_DOUBLE_EQ(57, h[19]);
  EXPECT_DOUBLE_EQ(235, h[20]);
  EXPECT_DOUBLE_EQ(51, h[21]);
  EXPECT_DOUBLE_EQ(447, h[22]);
  EXPECT_DOUBLE_EQ(263, h[23]);
}
...
TEST(AgradMixMatrixTraceQuadForm, mat_ffv_1st_deriv) {
  ...
  EXPECT_DOUBLE_EQ(16126, res.d_.val_.val());
...
TEST(AgradMixMatrixTraceQuadForm, mat_ffv_3rd_deriv) {
  ...
  EXPECT_DOUBLE_EQ(4, h[3]);
  EXPECT_DOUBLE_EQ(4, h[4]);
  EXPECT_DOUBLE_EQ(4, h[5]);
  EXPECT_DOUBLE_EQ(4, h[6]);
  EXPECT_DOUBLE_EQ(4, h[7]);
  EXPECT_DOUBLE_EQ(4, h[8]);
  EXPECT_DOUBLE_EQ(4, h[9]);
  EXPECT_DOUBLE_EQ(4, h[10]);
  EXPECT_DOUBLE_EQ(4, h[11]);
  EXPECT_DOUBLE_EQ(4, h[12]);
  EXPECT_DOUBLE_EQ(4, h[13]);
  EXPECT_DOUBLE_EQ(4, h[14]);
  EXPECT_DOUBLE_EQ(4, h[15]);
  EXPECT_DOUBLE_EQ(16, h[16]);
  EXPECT_DOUBLE_EQ(16, h[17]);
  EXPECT_DOUBLE_EQ(16, h[18]);
  EXPECT_DOUBLE_EQ(16, h[19]);
  EXPECT_DOUBLE_EQ(16, h[20]);
  EXPECT_DOUBLE_EQ(16, h[21]);
  EXPECT_DOUBLE_EQ(16, h[22]);
  EXPECT_DOUBLE_EQ(16, h[23]);
}
