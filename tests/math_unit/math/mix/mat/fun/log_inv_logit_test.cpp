...
INSTANTIATE_TYPED_TEST_CASE_P(log_inv_logit, prim_scalar_unary_test,
                              log_inv_logit_test);
INSTANTIATE_TYPED_TEST_CASE_P(log_inv_logit, rev_scalar_unary_test,
                              log_inv_logit_test);
INSTANTIATE_TYPED_TEST_CASE_P(log_inv_logit, fwd_scalar_unary_test,
                              log_inv_logit_test);
INSTANTIATE_TYPED_TEST_CASE_P(log_inv_logit, mix_scalar_unary_test,
                              log_inv_logit_test);
