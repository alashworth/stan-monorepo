...
TEST(AgradMixMatrixSD, fv_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(std::sqrt(1.0 / 14.0), sd(v1).d_.val());

  AVEC q = createAVEC(v1(0).val(), v1(1).val(), v1(2).val(), v1(3).val(),
                      v1(4).val(), v1(5).val());
  VEC h;
  sd(v1).val_.grad(q, h);
  EXPECT_DOUBLE_EQ(-std::sqrt(1.0 / 14.0), h[0]);
  EXPECT_DOUBLE_EQ(-std::sqrt(9.0 / 350.0), h[1]);
  EXPECT_DOUBLE_EQ(-std::sqrt(1.0 / 350.0), h[2]);
  EXPECT_DOUBLE_EQ(std::sqrt(1.0 / 350.0), h[3]);
  EXPECT_DOUBLE_EQ(std::sqrt(9.0 / 350.0), h[4]);
  EXPECT_DOUBLE_EQ(std::sqrt(1.0 / 14.0), h[5]);
...
TEST(AgradMixMatrixSD, fv_vector_2ndDeriv) {
  ...
  VEC h;
  sd(v1).d_.grad(q, h);
  EXPECT_DOUBLE_EQ(-std::sqrt(8.0 / 3087.0), h[0]);
  EXPECT_DOUBLE_EQ(8.0 / 105.0 * std::sqrt(2.0 / 7.0), h[1]);
  EXPECT_DOUBLE_EQ(std::sqrt(2.0 / 7.0 / 441.0), h[2]);
  EXPECT_DOUBLE_EQ(2.0 / 105.0 * std::sqrt(2.0 / 7.0), h[3]);
  EXPECT_DOUBLE_EQ(-std::sqrt(2.0 / 7.0) / 105.0, h[4]);
  EXPECT_DOUBLE_EQ(-4.0 / 105.0 * std::sqrt(2.0 / 7.0), h[5]);
}
...
TEST(AgradMixMatrixSD, ffv_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(std::sqrt(17.5 / 5.0), sd(v1).val_.val().val());
  EXPECT_DOUBLE_EQ(std::sqrt(1.0 / 14.0), sd(v1).d_.val().val());
  ...
  v1.resize(1);
  EXPECT_DOUBLE_EQ(0.0, sd(d1));
  EXPECT_DOUBLE_EQ(0.0, sd(v1).val_.val().val());
  EXPECT_DOUBLE_EQ(0.0, sd(v1).d_.val().val());
}
...
TEST(AgradMixMatrixSD, ffv_rowvector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(std::sqrt(17.5 / 5.0), sd(v1).val_.val().val());
  EXPECT_DOUBLE_EQ(0.26726124, sd(v1).d_.val().val());
