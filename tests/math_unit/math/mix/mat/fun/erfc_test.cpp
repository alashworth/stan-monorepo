...
INSTANTIATE_TYPED_TEST_CASE_P(erfc, prim_scalar_unary_test, erfc_test);
INSTANTIATE_TYPED_TEST_CASE_P(erfc, rev_scalar_unary_test, erfc_test);
INSTANTIATE_TYPED_TEST_CASE_P(erfc, fwd_scalar_unary_test, erfc_test);
INSTANTIATE_TYPED_TEST_CASE_P(erfc, mix_scalar_unary_test, erfc_test);
