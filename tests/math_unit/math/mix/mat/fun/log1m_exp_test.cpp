...
INSTANTIATE_TYPED_TEST_CASE_P(log1m_exp, prim_scalar_unary_test,
                              log1m_exp_test);
INSTANTIATE_TYPED_TEST_CASE_P(log1m_exp, rev_scalar_unary_test, log1m_exp_test);
INSTANTIATE_TYPED_TEST_CASE_P(log1m_exp, fwd_scalar_unary_test, log1m_exp_test);
INSTANTIATE_TYPED_TEST_CASE_P(log1m_exp, mix_scalar_unary_test, log1m_exp_test);
