...
INSTANTIATE_TYPED_TEST_CASE_P(cos, prim_scalar_unary_test, cos_test);
INSTANTIATE_TYPED_TEST_CASE_P(cos, rev_scalar_unary_test, cos_test);
INSTANTIATE_TYPED_TEST_CASE_P(cos, fwd_scalar_unary_test, cos_test);
INSTANTIATE_TYPED_TEST_CASE_P(cos, mix_scalar_unary_test, cos_test);
