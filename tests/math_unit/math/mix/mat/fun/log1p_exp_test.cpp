...
INSTANTIATE_TYPED_TEST_CASE_P(log1p_exp, prim_scalar_unary_test,
                              log1p_exp_test);
INSTANTIATE_TYPED_TEST_CASE_P(log1p_exp, rev_scalar_unary_test, log1p_exp_test);
INSTANTIATE_TYPED_TEST_CASE_P(log1p_exp, fwd_scalar_unary_test, log1p_exp_test);
INSTANTIATE_TYPED_TEST_CASE_P(log1p_exp, mix_scalar_unary_test, log1p_exp_test);
