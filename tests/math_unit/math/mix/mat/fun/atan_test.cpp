...
INSTANTIATE_TYPED_TEST_CASE_P(atan, prim_scalar_unary_test, atan_test);
INSTANTIATE_TYPED_TEST_CASE_P(atan, rev_scalar_unary_test, atan_test);
INSTANTIATE_TYPED_TEST_CASE_P(atan, fwd_scalar_unary_test, atan_test);
INSTANTIATE_TYPED_TEST_CASE_P(atan, mix_scalar_unary_test, atan_test);
