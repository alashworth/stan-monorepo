...
TEST(AgradMixMatrixProd, fv_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(1.0, prod(vv).val_.val());
  ...
  EXPECT_DOUBLE_EQ(2.0, prod(vv).val_.val());
  EXPECT_DOUBLE_EQ(1.0, prod(vv).d_.val());
  ...
  EXPECT_DOUBLE_EQ(6.0, f.val_.val());
  EXPECT_DOUBLE_EQ(5.0, f.d_.val());
...
TEST(AgradMixMatrixProd, fv_matrix_1stDeriv) {
  ...
  fvar<var> f = prod(vv);
  EXPECT_DOUBLE_EQ(36.0, prod(vd));
  EXPECT_DOUBLE_EQ(36.0, f.val_.val());
  EXPECT_DOUBLE_EQ(60.0, f.d_.val());

  AVEC q = createAVEC(vv(0, 0).val(), vv(0, 1).val(), vv(1, 0).val(),
                      vv(1, 1).val());
  VEC h;
  f.val_.grad(q, h);
  EXPECT_DOUBLE_EQ(18, h[0]);
  EXPECT_DOUBLE_EQ(12, h[1]);
  EXPECT_DOUBLE_EQ(18, h[2]);
  EXPECT_DOUBLE_EQ(12, h[3]);
}
TEST(AgradMixMatrixProd, fv_matrix_2ndDeriv) {
  ...
  VEC h;
  f.d_.grad(q, h);
  EXPECT_DOUBLE_EQ(21, h[0]);
  EXPECT_DOUBLE_EQ(16, h[1]);
  EXPECT_DOUBLE_EQ(21, h[2]);
  EXPECT_DOUBLE_EQ(16, h[3]);
}
TEST(AgradMixMatrixProd, ffv_vector_1stDeriv) {
  ...
  vector_ffv vv;
  EXPECT_DOUBLE_EQ(1.0, prod(vd));
  EXPECT_DOUBLE_EQ(1.0, prod(vv).val_.val().val());
  ...
  vv(0).d_ = 1.0;
  EXPECT_DOUBLE_EQ(2.0, prod(vd));
  EXPECT_DOUBLE_EQ(2.0, prod(vv).val_.val().val());
  EXPECT_DOUBLE_EQ(1.0, prod(vv).d_.val().val());
  ...
  EXPECT_DOUBLE_EQ(6.0, prod(vd));
  EXPECT_DOUBLE_EQ(6.0, f.val_.val().val());
  EXPECT_DOUBLE_EQ(5.0, f.d_.val().val());
...
TEST(AgradMixMatrixProd, ffv_matrix_1stDeriv) {
  ...
  fvar<fvar<var> > f = prod(vv);
  EXPECT_DOUBLE_EQ(36.0, prod(vd));
  EXPECT_DOUBLE_EQ(36.0, f.val_.val().val());
  EXPECT_DOUBLE_EQ(60.0, f.d_.val().val());
...
TEST(AgradMixMatrixProd, ffv_matrix_3rdDeriv) {
  ...
  VEC h;
  f.d_.d_.grad(q, h);
  EXPECT_DOUBLE_EQ(16, h[0]);
  EXPECT_DOUBLE_EQ(14, h[1]);
  EXPECT_DOUBLE_EQ(16, h[2]);
  EXPECT_DOUBLE_EQ(14, h[3]);
}
