...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_matrix_fv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(1, I(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(0.11111111, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(0, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.21527778, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.375, I(1, 1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_matrix_fv2_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.037037037, grads[0]);
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0, grads[3]);
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_vector_fv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_.val());
  EXPECT_DOUBLE_EQ(0.11111111, I(0).d_.val());
  EXPECT_DOUBLE_EQ(-0.090277776, I(1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_matrix_d1_lower) {
  ...
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(-0.22222222, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.33333333, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.38194445, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.54166669, I(1, 1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_matrix_d2_lower) {
  ...
  I(0, 0).d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(0.14814815, grads[0]);
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0, grads[3]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_vector_d1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_.val());
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_.val());
  EXPECT_DOUBLE_EQ(-0.22222222, I(0).d_.val());
  EXPECT_DOUBLE_EQ(-0.25694445, I(1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_d_matrix_fv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.33333334, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(0.16666666, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(0.16666666, I(1, 1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_d_vector_fv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.16666666, I(1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_matrix_ffv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(1, I(0, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.11111111, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.21527778, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.375, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_matrix_ffv4_lower) {
  ...
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0, grads[3]);
  EXPECT_DOUBLE_EQ(0.074074075, grads[4]);
  EXPECT_DOUBLE_EQ(0, grads[5]);
  EXPECT_DOUBLE_EQ(0, grads[6]);
  EXPECT_DOUBLE_EQ(0, grads[7]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_vector_ffv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.11111111, I(0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.090277776, I(1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_matrix_d1_lower) {
  ...
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.22222222, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.33333333, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.38194445, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.54166669, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_vector_d1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.22222222, I(0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.25694445, I(1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_d_matrix_ffv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.33333334, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.16666666, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.16666666, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_d_vector_ffv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.16666666, I(1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_matrix_fv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.25, I(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(0.41666666, I(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(-0.14583333, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.3263889, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.1875, I(1, 1).d_.val());
  ...
  I(0, 0).val_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(-0.083333336, grads[0]);
  EXPECT_DOUBLE_EQ(-0.41666666, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0.10416666, grads[3]);
  EXPECT_DOUBLE_EQ(0.33333333, grads[4]);
  EXPECT_DOUBLE_EQ(0, grads[5]);
  EXPECT_DOUBLE_EQ(-0.083333333, grads[6]);
  EXPECT_DOUBLE_EQ(0, grads[7]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_matrix_fv2_upper) {
  ...
  I(0, 0).d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(0.076388888, grads[0]);
  EXPECT_DOUBLE_EQ(0.15972222, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0.038194444, grads[3]);
  EXPECT_DOUBLE_EQ(-0.11111111, grads[4]);
  EXPECT_DOUBLE_EQ(0, grads[5]);
  EXPECT_DOUBLE_EQ(-0.034722224, grads[6]);
  EXPECT_DOUBLE_EQ(0, grads[7]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_vector_fv1_upper) {
  ...
  I = mdivide_left_tri<Eigen::Upper>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val());
  EXPECT_DOUBLE_EQ(-0.076388888, I(0).d_.val());
  EXPECT_DOUBLE_EQ(0.0625, I(1).d_.val());
  ...
  I(0).val_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(-0.1388889, grads[0]);
  EXPECT_DOUBLE_EQ(-0.25, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0.0625, grads[3]);
  EXPECT_DOUBLE_EQ(0.33333333, grads[4]);
  EXPECT_DOUBLE_EQ(-0.083333333, grads[5]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_vector_fv2_upper) {
  ...
  I(0).d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(0.071759261, grads[0]);
  EXPECT_DOUBLE_EQ(0.0625, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0.03125, grads[3]);
  EXPECT_DOUBLE_EQ(-0.11111111, grads[4]);
  EXPECT_DOUBLE_EQ(-0.034722224, grads[5]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_matrix_d1_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(-0.39583334, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.5763889, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.3125, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.4375, I(1, 1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_matrix_d2_upper) {
  ...
  I(0, 0).d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(0.15972222, grads[0]);
  EXPECT_DOUBLE_EQ(0.24305555, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0.017361112, grads[3]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_vector_d1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val());
  EXPECT_DOUBLE_EQ(-0.3263889, I(0).d_.val());
  EXPECT_DOUBLE_EQ(-0.1875, I(1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv_vector_d2_upper) {
  ...
  I(0).d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(0.1550926, grads[0]);
  EXPECT_DOUBLE_EQ(0.14583333, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0.010416667, grads[3]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_d_matrix_fv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(0.25, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(0.25, I(1, 0).d_.val());
  ...
  I(0, 0).val_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(0.33333333, grads[0]);
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(-0.083333333, grads[2]);
  EXPECT_DOUBLE_EQ(0, grads[3]);
}
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_d_vector_fv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(0).d_.val());
  ...
  I(0).val_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(0.33333334, grads[0]);
  EXPECT_DOUBLE_EQ(-0.083333336, grads[1]);
}
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_matrix_ffv1_upper) {
  ...
  I = mdivide_left_tri<Eigen::Upper>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.25, I(0, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.41666666, I(0, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.14583333, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.3263889, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.1875, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_matrix_ffv2_upper) {
  ...
  EXPECT_DOUBLE_EQ(-0.11111111, grads[4]);
  EXPECT_DOUBLE_EQ(0, grads[5]);
  EXPECT_DOUBLE_EQ(-0.034722222, grads[6]);
  EXPECT_DOUBLE_EQ(0, grads[7]);
}
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_matrix_ffv4_upper) {
  ...
  I(0, 0).d_.d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(-0.09375, grads[0]);
  EXPECT_DOUBLE_EQ(-0.11689815, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(-0.069733799, grads[3]);
  EXPECT_DOUBLE_EQ(0.074074075, grads[4]);
  EXPECT_DOUBLE_EQ(0, grads[5]);
  EXPECT_DOUBLE_EQ(0.054398149, grads[6]);
  EXPECT_DOUBLE_EQ(0, grads[7]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_vector_ffv1_upper) {
  ...
  I = mdivide_left_tri<Eigen::Upper>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.076388888, I(0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.0625, I(1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_vector_ffv4_upper) {
  ...
  I(0).d_.d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(-0.054398149, grads[0]);
  EXPECT_DOUBLE_EQ(-0.03125, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(-0.0390625, grads[3]);
  EXPECT_DOUBLE_EQ(0.074074075, grads[4]);
  EXPECT_DOUBLE_EQ(0.054398149, grads[5]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_matrix_d1_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.39583334, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.5763889, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.3125, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.4375, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_matrix_d4_upper) {
  ...
  I(0, 0).d_.d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(-0.24652778, grads[0]);
  EXPECT_DOUBLE_EQ(-0.21412037, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(-0.076678239, grads[3]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_vector_d1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.3263889, I(0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.1875, I(1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv_vector_d4_upper) {
  ...
  I(0).d_.d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(-0.20717593, grads[0]);
  EXPECT_DOUBLE_EQ(-0.12847222, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(-0.046006944, grads[3]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_d_matrix_ffv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(1, 0).d_.val_.val());
  ...
  EXPECT_DOUBLE_EQ(0.33333334, grads[0]);
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(-0.083333336, grads[2]);
  EXPECT_DOUBLE_EQ(0, grads[3]);
}
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_d_vector_ffv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(0).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(-0.083333333, I(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(0, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(-0.11111111, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.034722224, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(0, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 1).d_.val());
  ...
  I(0, 0).val_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(-0.11111111, grads[0]);
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0, grads[3]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv2_upper) {
  ...
  I(0, 0).d_.grad(vars, grads);
  EXPECT_DOUBLE_EQ(0.074074075, grads[0]);
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(0, grads[2]);
  EXPECT_DOUBLE_EQ(0, grads[3]);
}
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv1_upper) {
  ...
  I = mdivide_left_tri<Eigen::Upper>(Av);
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.083333333, I(0, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(0, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.11111111, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.034722224, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(0, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_fv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(0, I(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(-0.083333336, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(-0.11111111, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(0, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.034722224, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 1).d_.val());
...
TEST(AgradMixMatrixMdivideLeftTri, matrix_ffv1_lower) {
  ...
  I = mdivide_left_tri<Eigen::Lower>(Av);
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0, I(0, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.083333336, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.11111111, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.034722224, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 1).d_.val_.val());
