...
TEST(AgradMixMatrixDistance, vector_fv_vector_fv1) {
  ...
  EXPECT_DOUBLE_EQ(7.071068, a.val_.val());
  EXPECT_DOUBLE_EQ(0.84852815, a.d_.val());
  ...
  EXPECT_DOUBLE_EQ(-0.42426407, grads[0]);
  EXPECT_DOUBLE_EQ(0.70710677, grads[1]);
  EXPECT_DOUBLE_EQ(-0.56568545, grads[2]);
  EXPECT_DOUBLE_EQ(0.42426407, grads[3]);
  EXPECT_DOUBLE_EQ(-0.70710677, grads[4]);
  EXPECT_DOUBLE_EQ(0.56568545, grads[5]);

  v1.resize(0);
  v2.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(v1, v2).val_.val());
...
TEST(AgradMixMatrixDistance, vector_fv_vector_fv2) {
  ...
  EXPECT_DOUBLE_EQ(-0.37335238, grads[0]);
  EXPECT_DOUBLE_EQ(-0.50911689, grads[1]);
  EXPECT_DOUBLE_EQ(-0.3563818, grads[2]);
  EXPECT_DOUBLE_EQ(0.37335238, grads[3]);
  EXPECT_DOUBLE_EQ(0.50911689, grads[4]);
  EXPECT_DOUBLE_EQ(0.3563818, grads[5]);
}
...
TEST(AgradMixMatrixDistance, rowvector_fv_vector_fv1) {
  ...
  rv.resize(0);
  v.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(rv, v).val_.val());
...
TEST(AgradMixMatrixDistance, vector_fv_rowvector_fv1) {
  ...
  v.resize(0);
  rv.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(v, rv).val_.val());
...
TEST(AgradMixMatrixDistance, vector_fv_vector_ffv1) {
  ...
  EXPECT_DOUBLE_EQ(7.071068, a.val_.val_.val());
  EXPECT_DOUBLE_EQ(0.84852815, a.d_.val_.val());
  ...
  v1.resize(0);
  v2.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(v1, v2).val_.val_.val());
...
TEST(AgradMixMatrixDistance, vector_fv_vector_ffv4) {
  ...
  EXPECT_DOUBLE_EQ(0.31259775, grads[0]);
  EXPECT_DOUBLE_EQ(-0.24946727, grads[1]);
  EXPECT_DOUBLE_EQ(0.38285589, grads[2]);
  EXPECT_DOUBLE_EQ(-0.31259775, grads[3]);
  EXPECT_DOUBLE_EQ(0.24946727, grads[4]);
  EXPECT_DOUBLE_EQ(-0.38285589, grads[5]);
}
...
TEST(AgradMixMatrixDistance, rowvector_fv_vector_ffv1) {
  ...
  rv.resize(0);
  v.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(rv, v).val_.val_.val());
...
TEST(AgradMixMatrixDistance, vector_fv_rowvector_ffv1) {
  ...
  v.resize(0);
  rv.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(v, rv).val_.val_.val());
