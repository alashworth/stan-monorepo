...
INSTANTIATE_TYPED_TEST_CASE_P(acos, prim_scalar_unary_test, acos_test);
INSTANTIATE_TYPED_TEST_CASE_P(acos, rev_scalar_unary_test, acos_test);
INSTANTIATE_TYPED_TEST_CASE_P(acos, fwd_scalar_unary_test, acos_test);
INSTANTIATE_TYPED_TEST_CASE_P(acos, mix_scalar_unary_test, acos_test);
