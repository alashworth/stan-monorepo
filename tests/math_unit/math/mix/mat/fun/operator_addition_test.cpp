...
TEST(AgradMixMatrixOperatorAddition, fv_scalar_matrix_1stDeriv) {
  ...
  result = add(2.0, v);
  EXPECT_DOUBLE_EQ(3.0, result(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(4.0, result(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(5.0, result(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(6.0, result(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(1.0, result(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(1.0, result(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(1.0, result(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(1.0, result(1, 1).d_.val());
...
TEST(AgradMixMatrixOperatorAddition, fv_scalar_vector_1stDeriv) {
  ...
  result = add(2.0, v);
  EXPECT_DOUBLE_EQ(3.0, result(0).val_.val());
  EXPECT_DOUBLE_EQ(4.0, result(1).val_.val());
  EXPECT_DOUBLE_EQ(5.0, result(2).val_.val());
  EXPECT_DOUBLE_EQ(6.0, result(3).val_.val());
  EXPECT_DOUBLE_EQ(1.0, result(0).d_.val());
  EXPECT_DOUBLE_EQ(1.0, result(1).d_.val());
  EXPECT_DOUBLE_EQ(1.0, result(2).d_.val());
  EXPECT_DOUBLE_EQ(1.0, result(3).d_.val());
...
TEST(AgradMixMatrixOperatorAddition, fv_vector_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(expected_output(0), output_v(0).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(1), output_v(1).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(2), output_v(2).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(3), output_v(3).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(4), output_v(4).val_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(0).d_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(1).d_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(2).d_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(3).d_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(4).d_.val());
  ...
  EXPECT_DOUBLE_EQ(expected_output(3), output_v(3).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(4), output_v(4).val_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(0).d_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(1).d_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(2).d_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(3).d_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(4).d_.val());
...
TEST(AgradMixMatrixOperatorAddition, fv_matrix_matrix_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(expected_output(0, 0), output_v(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(0, 1), output_v(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(1, 0), output_v(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(1, 1), output_v(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(1.0, output_v(1, 1).d_.val());
  ...
  EXPECT_DOUBLE_EQ(expected_output(1, 0), output_v(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(expected_output(1, 1), output_v(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(2.0, output_v(1, 1).d_.val());
...
TEST(AgradMixMatrixOperatorAddition, ffv_scalar_matrix_1stDeriv) {
  ...
  result = add(2.0, v);
  EXPECT_DOUBLE_EQ(3.0, result(0, 0).val_.val().val());
  EXPECT_DOUBLE_EQ(4.0, result(0, 1).val_.val().val());
  EXPECT_DOUBLE_EQ(5.0, result(1, 0).val_.val().val());
  EXPECT_DOUBLE_EQ(6.0, result(1, 1).val_.val().val());
  EXPECT_DOUBLE_EQ(1.0, result(0, 0).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, result(0, 1).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, result(1, 0).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, result(1, 1).d_.val().val());
...
TEST(AgradMixMatrixOperatorAddition, ffv_scalar_vector_1stDeriv) {
  ...
  result = add(2.0, v);
  EXPECT_DOUBLE_EQ(3.0, result(0).val_.val().val());
  EXPECT_DOUBLE_EQ(4.0, result(1).val_.val().val());
  EXPECT_DOUBLE_EQ(5.0, result(2).val_.val().val());
  EXPECT_DOUBLE_EQ(6.0, result(3).val_.val().val());
  EXPECT_DOUBLE_EQ(1.0, result(0).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, result(1).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, result(2).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, result(3).d_.val().val());
...
TEST(AgradMixMatrixOperatorAddition, ffv_vector_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(expected_output(0), output_v(0).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(1), output_v(1).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(2), output_v(2).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(3), output_v(3).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(4), output_v(4).val_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(0).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(1).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(2).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(3).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(4).d_.val().val());
  ...
  EXPECT_DOUBLE_EQ(expected_output(3), output_v(3).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(4), output_v(4).val_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(0).d_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(1).d_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(2).d_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(3).d_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(4).d_.val().val());
...
TEST(AgradMixMatrixOperatorAddition, ffv_matrix_matrix_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(expected_output(0, 0), output_v(0, 0).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(0, 1), output_v(0, 1).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(1, 0), output_v(1, 0).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(1, 1), output_v(1, 1).val_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(0, 0).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(0, 1).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(1, 0).d_.val().val());
  EXPECT_DOUBLE_EQ(1.0, output_v(1, 1).d_.val().val());
  ...
  EXPECT_DOUBLE_EQ(expected_output(1, 0), output_v(1, 0).val_.val().val());
  EXPECT_DOUBLE_EQ(expected_output(1, 1), output_v(1, 1).val_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(0, 0).d_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(0, 1).d_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(1, 0).d_.val().val());
  EXPECT_DOUBLE_EQ(2.0, output_v(1, 1).d_.val().val());
