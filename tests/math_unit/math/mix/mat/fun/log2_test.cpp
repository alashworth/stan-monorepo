...
INSTANTIATE_TYPED_TEST_CASE_P(log2, prim_scalar_unary_test, log2_test);
INSTANTIATE_TYPED_TEST_CASE_P(log2, rev_scalar_unary_test, log2_test);
INSTANTIATE_TYPED_TEST_CASE_P(log2, fwd_scalar_unary_test, log2_test);
INSTANTIATE_TYPED_TEST_CASE_P(log2, mix_scalar_unary_test, log2_test);
