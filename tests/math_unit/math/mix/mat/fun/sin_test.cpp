...
INSTANTIATE_TYPED_TEST_CASE_P(sin, prim_scalar_unary_test, sin_test);
INSTANTIATE_TYPED_TEST_CASE_P(sin, rev_scalar_unary_test, sin_test);
INSTANTIATE_TYPED_TEST_CASE_P(sin, fwd_scalar_unary_test, sin_test);
INSTANTIATE_TYPED_TEST_CASE_P(sin, mix_scalar_unary_test, sin_test);
