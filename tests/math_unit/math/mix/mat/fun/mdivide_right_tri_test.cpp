...
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_matrix_fv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.416666667, I(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(-0.0763888889, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(0.0625, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.5486111, I(1, 0).d_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_matrix_fv2_lower) {
  ...
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(0.0625, grads[2]);
  EXPECT_DOUBLE_EQ(0.03125, grads[3]);
  EXPECT_DOUBLE_EQ(-0.11111111, grads[4]);
  EXPECT_DOUBLE_EQ(-0.034722222, grads[5]);
  EXPECT_DOUBLE_EQ(0, grads[6]);
  EXPECT_DOUBLE_EQ(0, grads[7]);
}
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_row_vector_fv1_lower) {
  ...
  I = mdivide_right_tri<Eigen::Lower>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.41666667, I(0).val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val());
  EXPECT_DOUBLE_EQ(-0.0763888889, I(0).d_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_matrix_d1_lower) {
  ...
  I = mdivide_right_tri<Eigen::Lower>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.41666667, I(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(-0.3263889, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.1875, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.7986111, I(1, 0).d_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_matrix_d2_lower) {
  ...
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(0.14583333, grads[2]);
...
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_row_vector_d1_lower) {
  ...
  I = mdivide_right_tri<Eigen::Lower>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.416666667, I(0).val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_d_matrix_fv1_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.41666667, I(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(1.0833333, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val());
  ...
  EXPECT_DOUBLE_EQ(-0.083333333, grads[1]);
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_matrix_ffv1_lower) {
  ...
  I = mdivide_right_tri<Eigen::Lower>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.416666667, I(0, 0).val_.val_.val());
  ...
  EXPECT_DOUBLE_EQ(-0.0763888889, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.0625, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.5486111, I(1, 0).d_.val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_matrix_ffv4_lower) {
  ...
  EXPECT_DOUBLE_EQ(-0.054398148148148161, grads[0]);
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(-0.03125, grads[2]);
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_row_vector_ffv1_lower) {
  ...
  I = mdivide_right_tri<Eigen::Lower>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.416666667, I(0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.0763888889, I(0).d_.val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_matrix_d1_lower) {
  ...
  I = mdivide_right_tri<Eigen::Lower>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.41666667, I(0, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(0, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.3263889, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.1875, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.7986111, I(1, 0).d_.val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_matrix_d4_lower) {
  ...
  EXPECT_DOUBLE_EQ(0, grads[1]);
  EXPECT_DOUBLE_EQ(-0.12847222, grads[2]);
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_row_vector_d1_lower) {
  ...
  I = mdivide_right_tri<Eigen::Lower>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.41666667, I(0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_matrix_fv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.66666667, I(0, 0).val_.val());
  EXPECT_DOUBLE_EQ(0.58333333, I(0, 1).val_.val());
  EXPECT_DOUBLE_EQ(1.6666667, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.3333333, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(0.11111111, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.090277778, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.22222222, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.44444444, I(1, 1).d_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_row_vector_fv1_upper) {
  ...
  I = mdivide_right_tri<Eigen::Upper>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.66666666, I(0).val_.val());
  EXPECT_DOUBLE_EQ(0.58333333, I(1).val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_fv_matrix_d1_upper) {
  ...
  EXPECT_DOUBLE_EQ(-0.25694445, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(-0.55555556, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(-0.6111111, I(1, 1).d_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_d_matrix_fv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.6666667, I(1, 0).val_.val());
  EXPECT_DOUBLE_EQ(1.3333333, I(1, 1).val_.val());
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).d_.val());
  EXPECT_DOUBLE_EQ(0.16666667, I(0, 1).d_.val());
  EXPECT_DOUBLE_EQ(0.33333333, I(1, 0).d_.val());
  EXPECT_DOUBLE_EQ(0.16666667, I(1, 1).d_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_d_row_vector_fv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.66666666, I(0).val_.val());
  EXPECT_DOUBLE_EQ(0.58333333, I(1).val_.val());
  EXPECT_DOUBLE_EQ(0.33333333, I(0).d_.val());
  EXPECT_DOUBLE_EQ(0.16666667, I(1).d_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_matrix_ffv1_upper) {
  ...
  I = mdivide_right_tri<Eigen::Upper>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.66666667, I(0, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.58333333, I(0, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.6666667, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.3333333, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.11111111, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.090277778, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.22222222, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.44444444, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_row_vector_ffv1_upper) {
  ...
  I = mdivide_right_tri<Eigen::Upper>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.66666666, I(0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.58333333, I(1).val_.val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_ffv_matrix_d1_upper) {
  ...
  I = mdivide_right_tri<Eigen::Upper>(Ad, Av);
  EXPECT_DOUBLE_EQ(0.66666666, I(0, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.58333333, I(0, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.6666666, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.3333333, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(-0.22222222, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.25694445, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.55555558, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.6111111, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_d_matrix_ffv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.6666666, I(1, 0).val_.val_.val());
  EXPECT_DOUBLE_EQ(1.3333333, I(1, 1).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.166666667, I(0, 1).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.33333333, I(1, 0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.16666667, I(1, 1).d_.val_.val());
...
TEST(AgradMixMatrixMdivideRightTri, matrix_d_row_vector_ffv1_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.66666666, I(0).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.58333333, I(1).val_.val_.val());
  EXPECT_DOUBLE_EQ(0.33333333, I(0).d_.val_.val());
  EXPECT_DOUBLE_EQ(0.16666667, I(1).d_.val_.val());
