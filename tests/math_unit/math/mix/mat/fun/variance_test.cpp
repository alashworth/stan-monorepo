...
TEST(AgradMixMatrixVariance, fv_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(-0.6, h[1]);
  EXPECT_DOUBLE_EQ(-0.2, h[2]);
  EXPECT_DOUBLE_EQ(0.2, h[3]);
  EXPECT_DOUBLE_EQ(0.6, h[4]);
...
TEST(AgradMixMatrixVariance, fv_vector_2ndDeriv) {
  ...
  EXPECT_DOUBLE_EQ(-1.0 / 3.0, h[0]);
  EXPECT_DOUBLE_EQ(1.0 / 15.0, h[1]);
  EXPECT_DOUBLE_EQ(1.0 / 15.0, h[2]);
  EXPECT_DOUBLE_EQ(1.0 / 15.0, h[3]);
  EXPECT_DOUBLE_EQ(1.0 / 15.0, h[4]);
  EXPECT_DOUBLE_EQ(1.0 / 15.0, h[5]);
}
...
TEST(AgradMixMatrixVariance, fv_rowvector_2ndDeriv) {
  ...
  VEC h;
  variance(v1).d_.grad(q, h);
  EXPECT_DOUBLE_EQ(3, h[0]);
  EXPECT_DOUBLE_EQ(-.6, h[1]);
  EXPECT_DOUBLE_EQ(-.6, h[2]);
  EXPECT_DOUBLE_EQ(-.6, h[3]);
  EXPECT_DOUBLE_EQ(-.6, h[4]);
  EXPECT_DOUBLE_EQ(-.6, h[5]);
}
...
TEST(AgradMixMatrixVariance, fv_StdVector_1stDeriv) {
  ...
  VEC h;
  f1.val_.grad(q, h);
  EXPECT_DOUBLE_EQ(-1.5, h[0]);
  EXPECT_DOUBLE_EQ(0, h[1]);
  EXPECT_DOUBLE_EQ(1.5, h[2]);
}
TEST(AgradMixMatrixVariance, fv_StdVector_2ndDeriv) {
  ...
  EXPECT_DOUBLE_EQ(1.0 / 3.0, h[1]);
  EXPECT_DOUBLE_EQ(1.0 / 3.0, h[2]);
}
TEST(AgradMixMatrixVariance, ffv_vector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(17.5 / 5.0, variance(v1).val_.val().val());
  EXPECT_DOUBLE_EQ(1.0, variance(v1).d_.val().val());
  ...
  v1.resize(1);
  EXPECT_DOUBLE_EQ(0.0, variance(d1));
  EXPECT_DOUBLE_EQ(0.0, variance(v1).val_.val().val());
  EXPECT_DOUBLE_EQ(0.0, variance(v1).d_.val().val());
}
...
TEST(AgradMixMatrixVariance, ffv_rowvector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(17.5 / 5.0, variance(v1).val_.val().val());
  EXPECT_DOUBLE_EQ(-9.0, variance(v1).d_.val().val());
...
TEST(AgradMixMatrixVariance, ffv_StdVector_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(2.25, f1.val_.val().val());
  EXPECT_DOUBLE_EQ(1.5, f1.d_.val().val());
