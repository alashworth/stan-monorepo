...
INSTANTIATE_TYPED_TEST_CASE_P(inv, prim_scalar_unary_test, inv_test);
INSTANTIATE_TYPED_TEST_CASE_P(inv, rev_scalar_unary_test, inv_test);
INSTANTIATE_TYPED_TEST_CASE_P(inv, fwd_scalar_unary_test, inv_test);
INSTANTIATE_TYPED_TEST_CASE_P(inv, mix_scalar_unary_test, inv_test);
