...
INSTANTIATE_TYPED_TEST_CASE_P(floor, prim_scalar_unary_test, floor_test);
INSTANTIATE_TYPED_TEST_CASE_P(floor, rev_scalar_unary_test, floor_test);
INSTANTIATE_TYPED_TEST_CASE_P(floor, fwd_scalar_unary_test, floor_test);
INSTANTIATE_TYPED_TEST_CASE_P(floor, mix_scalar_unary_test, floor_test);
