...
TEST(AgradFwdGammaQ, FvarVar_FvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(boost::math::gamma_q(0.5, 1.0), a.val_.val());
  EXPECT_DOUBLE_EQ(0.18228334, a.d_.val());
...
TEST(AgradFwdGammaQ, Double_FvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(boost::math::gamma_q(0.5, 1.0), a.val_.val());
  EXPECT_DOUBLE_EQ(-boost::math::gamma_p_derivative(0.5, 1.0), a.d_.val());
...
TEST(AgradFwdGammaQ, FvarVar_Double_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(boost::math::gamma_q(0.5, 1.0), a.val_.val());
  EXPECT_DOUBLE_EQ(0.38983709, a.d_.val());
...
TEST(AgradFwdGammaQ, FvarVar_FvarVar_2ndDeriv) {
  ...
  VEC g;
  a.d_.grad(y, g);
  EXPECT_DOUBLE_EQ(-0.19403456, g[0]);
  EXPECT_DOUBLE_EQ(-0.096204743, g[1]);
}
TEST(AgradFwdGammaQ, Double_FvarVar_2ndDeriv) {
  ...
  VEC g;
  a.d_.grad(y, g);
  EXPECT_DOUBLE_EQ(0.31133062, g[0]);
}
TEST(AgradFwdGammaQ, FvarVar_Double_2ndDeriv) {
  ...
  VEC g;
  a.d_.grad(y, g);
  EXPECT_DOUBLE_EQ(0.21349931, g[0]);
}
...
TEST(AgradFwdGammaQ, FvarFvarVar_FvarFvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(gamma_q(0.5, 1.0), a.val_.val_.val());
  EXPECT_DOUBLE_EQ(0.38983709, a.val_.d_.val());
  EXPECT_DOUBLE_EQ(-boost::math::gamma_p_derivative(0.5, 1.0), a.d_.val_.val());
  EXPECT_DOUBLE_EQ(-0.40753385, a.d_.d_.val());
...
TEST(AgradFwdGammaQ, FvarFvarVar_FvarFvarVar_2ndDeriv_x) {
  ...
  a.val_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(0.21349931, g[0]);
  EXPECT_DOUBLE_EQ(-0.40753537, g[1]);
}
TEST(AgradFwdGammaQ, FvarFvarVar_FvarFvarVar_2ndDeriv_y) {
  ...
  VEC g;
  a.d_.val_.grad(p, g);
  EXPECT_DOUBLE_EQ(-0.40753385, g[0]);
  EXPECT_DOUBLE_EQ(0.31133062, g[1]);
}
...
TEST(AgradFwdGammaQ, FvarFvarVar_FvarFvarVar_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(0.22403987, g[0]);
  EXPECT_DOUBLE_EQ(0.40374705, g[1]);
}
TEST(AgradFwdGammaQ, Double_FvarFvarVar_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(-0.57077283, g[0]);
}
TEST(AgradFwdGammaQ, FvarFvarVar_Double_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(-0.5462361, g[0]);
}
