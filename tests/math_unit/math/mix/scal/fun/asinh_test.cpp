...
TEST_F(AgradFwdAsinh, FvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(asinh(1.5), a.val_.val());
...
TEST_F(AgradFwdAsinh, FvarVar_2ndDeriv) {
  ...
  VEC g;
  a.d_.grad(y, g);
  EXPECT_DOUBLE_EQ(1.3 * -0.25601548, g[0]);
}
...
TEST_F(AgradFwdAsinh, FvarFvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(asinh(1.5), a.val_.val_.val());
  ...
  EXPECT_DOUBLE_EQ(2.0 / sqrt(1.0 + 1.5 * 1.5), a.d_.val_.val());
  EXPECT_DOUBLE_EQ(0, a.d_.d_.val());
...
TEST_F(AgradFwdAsinh, FvarFvarVar_2ndDeriv) {
  ...
  VEC g;
  a.val_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(2.0 * -0.25601548, g[0]);
  ...
  VEC r;
  b.d_.val_.grad(q, r);
  EXPECT_DOUBLE_EQ(2.0 * -0.25601548, r[0]);
}
TEST_F(AgradFwdAsinh, FvarFvarVar_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(0.183805982181141, g[0]);
}
struct asinh_fun {
