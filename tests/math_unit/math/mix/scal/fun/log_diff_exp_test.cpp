...
TEST(AgradFwdLogDiffExp, FvarVar_FvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(log_diff_exp(9.0, 6.0), a.val_.val());
  EXPECT_DOUBLE_EQ((1.3 * exp(9.0) - 1.0 * exp(6.0)) / (exp(9.0) - exp(6.0)),
                   a.d_.val());

  AVEC y = createAVEC(x.val_, z.val_);
  VEC g;
  a.val_.grad(y, g);
  EXPECT_DOUBLE_EQ(exp(9.0) / (exp(9.0) - exp(6.0)), g[0]);
  EXPECT_DOUBLE_EQ(-exp(6.0) / (exp(9.0) - exp(6.0)), g[1]);
}
TEST(AgradFwdLogDiffExp, FvarVar_Double_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(log_diff_exp(9.0, 6.0), a.val_.val());
  EXPECT_DOUBLE_EQ((1.3 * exp(9.0)) / (exp(9.0) - exp(6.0)), a.d_.val());
...
TEST(AgradFwdLogDiffExp, Double_FvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(log_diff_exp(9.0, 6.0), a.val_.val());
  EXPECT_DOUBLE_EQ((-1.0 * exp(6.0)) / (exp(9.0) - exp(6.0)), a.d_.val());

  AVEC y = createAVEC(z.val_);
  VEC g;
  a.val_.grad(y, g);
  EXPECT_DOUBLE_EQ(-exp(6.0) / (exp(9.0) - exp(6.0)), g[0]);
}
TEST(AgradFwdLogDiffExp, FvarVar_FvarVar_2ndDeriv) {
  ...
  VEC g;
  a.d_.grad(y, g);
  EXPECT_DOUBLE_EQ((1.3 * exp(9.0) * (exp(9.0) - exp(6.0))
                    - exp(9.0) * (1.3 * exp(9.0) - exp(6.0)))
                      / (exp(9.0) - exp(6.0)) / (exp(9.0) - exp(6.0)),
                  g[0]);
  EXPECT_DOUBLE_EQ((-exp(6.0) * (exp(9.0) - exp(6.0))
...
TEST(AgradFwdLogDiffExp, Double_FvarVar_2ndDeriv) {
  ...
  VEC g;
  a.d_.grad(y, g);
  EXPECT_DOUBLE_EQ((-exp(6.0) * (exp(9.0) - exp(6.0)) + exp(6.0) * -exp(6.0))
                       / (exp(9.0) - exp(6.0)) / (exp(9.0) - exp(6.0)),
                  g[0]);
}
TEST(AgradFwdLogDiffExp, FvarFvarVar_FvarFvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(log_diff_exp(9.0, 6.0), a.val_.val_.val());
  EXPECT_DOUBLE_EQ(exp(9.0) / (exp(9.0) - exp(6.0)), a.val_.d_.val());
  EXPECT_DOUBLE_EQ(-exp(6.0) / (exp(9.0) - exp(6.0)), a.d_.val_.val());
  EXPECT_DOUBLE_EQ(0.055141006, a.d_.d_.val());
...
TEST(AgradFwdLogDiffExp, FvarFvarVar_FvarFvarVar_2ndDeriv_x) {
  ...
  VEC g;
  a.val_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ((exp(9.0) * (exp(9.0) - exp(6.0)) - exp(9.0) * exp(9.0))
                       / (exp(9.0) - exp(6.0)) / (exp(9.0) - exp(6.0)),
                  g[0]);
  EXPECT_DOUBLE_EQ(0.055141006, g[1]);
}
TEST(AgradFwdLogDiffExp, FvarFvarVar_FvarFvarVar_2ndDeriv_y) {
  ...
  VEC g;
  a.d_.val_.grad(p, g);
  EXPECT_DOUBLE_EQ(0.055141006, g[0]);
  EXPECT_DOUBLE_EQ((-exp(6.0) * (exp(9.0) - exp(6.0)) + exp(6.0) * -exp(6.0))
                       / (exp(9.0) - exp(6.0)) / (exp(9.0) - exp(6.0)),
                  g[1]);
}
...
TEST(AgradFwdLogDiffExp, FvarFvarVar_FvarFvarVar_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(-0.060919307, g[0]);
  EXPECT_DOUBLE_EQ(0.060919307, g[1]);
}
TEST(AgradFwdLogDiffExp, FvarFvarVar_Double_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(0.060919308279076959008006310, g[0]);
}
...
TEST(AgradFwdLogDiffExp, Double_FvarFvarVar_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(-0.060919308279076959008006309952, g[0]);
}
