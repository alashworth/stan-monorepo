...
TEST(AgradFwdTrunc, FvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(trunc(1.5), a.val_.val());
...
TEST(AgradFwdTrunc, FvarFvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(trunc(1.5), a.val_.val_.val());
  ...
  EXPECT_DOUBLE_EQ(trunc(1.5), b.val_.val_.val());
...
TEST(AgradFwdTrunc, FvarFvarDouble) {
  ...
  EXPECT_DOUBLE_EQ(trunc(1.5), a.val_.val_);
