...
TEST(AgradFwdErfc, FvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(erfc(0.5), a.val_.val());
  EXPECT_DOUBLE_EQ(
...
TEST(AgradFwdErfc, FvarFvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(erfc(0.5), a.val_.val_.val());
  EXPECT_DOUBLE_EQ(
  ...
  EXPECT_DOUBLE_EQ(erfc(0.5), b.val_.val_.val());
...
TEST(AgradFwdErfc, FvarFvarVar_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(0.878782578935444794093723954824, g[0]);
}
