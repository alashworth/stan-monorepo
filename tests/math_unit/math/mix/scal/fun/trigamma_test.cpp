...
TEST(AgradFwdTrigamma, FvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(4.9348022005446793094, a.val_.val());
  EXPECT_DOUBLE_EQ(1.3 * -16.8288, a.d_.val());

  AVEC y = createAVEC(x.val_);
  VEC g;
  a.val_.grad(y, g);
  EXPECT_DOUBLE_EQ(-16.8288, g[0]);
}
TEST(AgradFwdTrigamma, FvarVar_2ndDeriv) {
  ...
  VEC g;
  a.d_.grad(y, g);
  EXPECT_DOUBLE_EQ(126.63182, g[0]);
}
TEST(AgradFwdTrigamma, FvarFvarDouble) {
  ...
  EXPECT_DOUBLE_EQ(4.9348022005446793094, a.val_.val_);
  EXPECT_DOUBLE_EQ(-16.8288, a.val_.d_);
  ...
  EXPECT_DOUBLE_EQ(-16.8288, a.d_.val_);
  EXPECT_DOUBLE_EQ(0, a.d_.d_);
}
TEST(AgradFwdTrigamma, FvarFvarVar_1stDeriv) {
  ...
  EXPECT_DOUBLE_EQ(4.9348022005446793094, a.val_.val_.val());
  EXPECT_DOUBLE_EQ(-16.8288, a.val_.d_.val());
  ...
  EXPECT_DOUBLE_EQ(4.9348022005446793094, b.val_.val_.val());
  EXPECT_DOUBLE_EQ(0, b.val_.d_.val());
  EXPECT_DOUBLE_EQ(-16.8288, b.d_.val_.val());
  EXPECT_DOUBLE_EQ(0, b.d_.d_.val());

  AVEC q = createAVEC(y.val_.val_);
  VEC r;
  b.val_.val_.grad(q, r);
  EXPECT_DOUBLE_EQ(-16.8288, r[0]);
}
TEST(AgradFwdTrigamma, FvarFvarVar_2ndDeriv) {
  ...
  VEC g;
  a.val_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(97.409088, g[0]);
  ...
  VEC r;
  b.d_.val_.grad(q, r);
  EXPECT_DOUBLE_EQ(97.409088, r[0]);
}
TEST(AgradFwdTrigamma, FvarFvarVar_3rdDeriv) {
  ...
  VEC g;
  a.d_.d_.grad(p, g);
  EXPECT_DOUBLE_EQ(-771.47424982666722519053592192, g[0]);
}
