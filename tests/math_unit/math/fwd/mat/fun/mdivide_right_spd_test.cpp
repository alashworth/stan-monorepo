...
TEST(AgradFwdMatrixMdivideRightSPD, matrix_fd_matrix_fd) {
  ...
  EXPECT_DOUBLE_EQ(0.75, I(0, 1).val_);
  EXPECT_DOUBLE_EQ(1.6666666, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(7.0 / 4.0, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(-0.1388889, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(-0.10416666, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(-0.80555558, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(-0.60416669, I(1, 1).d_);
}
TEST(AgradFwdMatrixMdivideRightSPD, matrix_fd_row_vector_fd) {
  ...
  EXPECT_DOUBLE_EQ(3.0 / 4.0, I(1).val_);
  EXPECT_DOUBLE_EQ(-0.1388889, I(0).d_);
  EXPECT_DOUBLE_EQ(-0.10416666, I(1).d_);
}
TEST(AgradFwdMatrixMdivideRightSPD, matrix_fd_matrix_d) {
  ...
  EXPECT_DOUBLE_EQ(1.6666666, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(7.0 / 4.0, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(-0.47222221, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(-0.35416666, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(-1.1388888, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(-0.85416669, I(1, 1).d_);
}
TEST(AgradFwdMatrixMdivideRightSPD, matrix_fd_row_vector_d) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_);
  EXPECT_DOUBLE_EQ(3.0 / 4.0, I(1).val_);
  EXPECT_DOUBLE_EQ(-0.47222221, I(0).d_);
  EXPECT_DOUBLE_EQ(-0.35416666, I(1).d_);
}
TEST(AgradFwdMatrixMdivideRightSPD, matrix_d_matrix_fd) {
  ...
  EXPECT_DOUBLE_EQ(0.33333334, I(1, 0).d_);
...
TEST(AgradFwdMatrixMdivideRightSPD, matrix_ffd_matrix_ffd) {
  ...
  EXPECT_DOUBLE_EQ(0.75, I(0, 1).val_.val_);
  EXPECT_DOUBLE_EQ(1.6666666, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(7.0 / 4.0, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.1388889, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.10416666, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(-0.80555558, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.60416669, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideRightSPD, matrix_ffd_row_vector_ffd) {
  ...
  EXPECT_DOUBLE_EQ(3.0 / 4.0, I(1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.1388889, I(0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.10416666, I(1).d_.val_);
}
TEST(AgradFwdMatrixMdivideRightSPD, matrix_ffd_matrix_d) {
  ...
  EXPECT_DOUBLE_EQ(-0.47222221, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.35416666, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(-1.1388888, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.85416669, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideRightSPD, matrix_ffd_row_vector_d) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_.val_);
  EXPECT_DOUBLE_EQ(3.0 / 4.0, I(1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.47222221, I(0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.35416666, I(1).d_.val_);
}
TEST(AgradFwdMatrixMdivideRightSPD, matrix_d_matrix_ffd) {
  ...
  EXPECT_DOUBLE_EQ(0.33333334, I(1, 0).d_.val_);
