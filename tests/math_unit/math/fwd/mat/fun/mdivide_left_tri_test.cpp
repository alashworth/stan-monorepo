...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_matrix_fd_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0, 0).val_);
  EXPECT_DOUBLE_EQ(1, I(0, 1).val_);
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(0.11111111, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(0, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(-0.21527778, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(-0.375, I(1, 1).d_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_vector_fd_lower) {
  ...
  I = mdivide_left_tri<Eigen::Lower>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_);
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_);
  EXPECT_DOUBLE_EQ(0.11111111, I(0).d_);
  EXPECT_DOUBLE_EQ(-0.090277776, I(1).d_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_matrix_d_lower) {
  ...
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(-0.22222222, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(-0.33333333, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(-0.38194445, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(-0.54166669, I(1, 1).d_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_vector_d_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_);
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_);
  EXPECT_DOUBLE_EQ(-0.22222222, I(0).d_);
  EXPECT_DOUBLE_EQ(-0.25694445, I(1).d_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_d_matrix_fd_lower) {
  ...
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(0.33333334, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(0.33333334, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(0.16666666, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(0.16666666, I(1, 1).d_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_d_vector_fd_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_);
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_);
  EXPECT_DOUBLE_EQ(0.33333334, I(0).d_);
  EXPECT_DOUBLE_EQ(0.16666666, I(1).d_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_matrix_ffd_lower) {
  ...
  I = mdivide_left_tri<Eigen::Lower>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.66666669, I(0, 0).val_.val_);
  EXPECT_DOUBLE_EQ(1, I(0, 1).val_.val_);
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(0.11111111, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(0., I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(-0.21527778, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.375, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_vector_ffd_lower) {
  ...
  I = mdivide_left_tri<Eigen::Lower>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_.val_);
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_.val_);
  EXPECT_DOUBLE_EQ(0.11111111, I(0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.090277776, I(1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_matrix_d_lower) {
  ...
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.22222222, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.33333333, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(-0.38194445, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.54166669, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_vector_d_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_.val_);
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.22222222, I(0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.25694445, I(1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_d_matrix_ffd_lower) {
  ...
  EXPECT_DOUBLE_EQ(1.0833334, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(1.5, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(0.33333334, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(0.33333334, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(0.16666666, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(0.16666666, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_d_vector_ffd_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.66666669, I(0).val_.val_);
  EXPECT_DOUBLE_EQ(0.58333331, I(1).val_.val_);
  EXPECT_DOUBLE_EQ(0.33333334, I(0).d_.val_);
  EXPECT_DOUBLE_EQ(0.16666666, I(1).d_.val_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_matrix_fd_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.25, I(0, 0).val_);
  EXPECT_DOUBLE_EQ(0.41666666, I(0, 1).val_);
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(-0.14583333, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(-0.3263889, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(-0.1875, I(1, 1).d_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_vector_fd_upper) {
  ...
  I = mdivide_left_tri<Eigen::Upper>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_);
  EXPECT_DOUBLE_EQ(0.75, I(1).val_);
  EXPECT_DOUBLE_EQ(-0.076388888, I(0).d_);
  EXPECT_DOUBLE_EQ(0.0625, I(1).d_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_matrix_d_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(-0.39583334, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(-0.5763889, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(-0.3125, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(-0.4375, I(1, 1).d_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_vector_d_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_);
  EXPECT_DOUBLE_EQ(0.75, I(1).val_);
  EXPECT_DOUBLE_EQ(-0.3263889, I(0).d_);
  EXPECT_DOUBLE_EQ(-0.1875, I(1).d_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_d_matrix_fd_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(0.25, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(0.25, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(0.25, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).d_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_d_vector_fd_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_);
  EXPECT_DOUBLE_EQ(0.75, I(1).val_);
  EXPECT_DOUBLE_EQ(0.25, I(0).d_);
  EXPECT_DOUBLE_EQ(0.25, I(1).d_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_matrix_ffd_upper) {
  ...
  I = mdivide_left_tri<Eigen::Upper>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.25, I(0, 0).val_.val_);
  EXPECT_DOUBLE_EQ(0.41666666, I(0, 1).val_.val_);
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.14583333, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.3263889, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.1875, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_vector_ffd_upper) {
  ...
  I = mdivide_left_tri<Eigen::Upper>(Av, Ad);
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val_);
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.076388888, I(0).d_.val_);
  EXPECT_DOUBLE_EQ(0.0625, I(1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_matrix_d_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.39583334, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.5763889, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(-0.3125, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.4375, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_vector_d_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val_);
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.3263889, I(0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.1875, I(1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_d_matrix_ffd_upper) {
  ...
  EXPECT_DOUBLE_EQ(1.25, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(1.75, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(0.25, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(0.25, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(0.25, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_d_vector_ffd_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.41666666, I(0).val_.val_);
  EXPECT_DOUBLE_EQ(0.75, I(1).val_.val_);
  EXPECT_DOUBLE_EQ(0.25, I(0).d_.val_);
  EXPECT_DOUBLE_EQ(0.25, I(1).d_.val_);
}
...
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_upper) {
  ...
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).val_);
  EXPECT_DOUBLE_EQ(-0.083333333, I(0, 1).val_);
  EXPECT_DOUBLE_EQ(0, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(-0.11111111, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(-0.034722224, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(0, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 1).d_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_upper) {
  ...
  I = mdivide_left_tri<Eigen::Upper>(Av);
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).val_.val_);
  EXPECT_DOUBLE_EQ(-0.083333333, I(0, 1).val_.val_);
  EXPECT_DOUBLE_EQ(0, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.11111111, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.034722224, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(0, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 1).d_.val_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_fd_lower) {
  ...
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).val_);
  EXPECT_DOUBLE_EQ(0, I(0, 1).val_);
  EXPECT_DOUBLE_EQ(-0.083333333, I(1, 0).val_);
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).val_);
  EXPECT_DOUBLE_EQ(-0.11111111, I(0, 0).d_);
  EXPECT_DOUBLE_EQ(0, I(0, 1).d_);
  EXPECT_DOUBLE_EQ(-0.034722224, I(1, 0).d_);
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 1).d_);
}
TEST(AgradFwdMatrixMdivideLeftTri, matrix_ffd_lower) {
  ...
  I = mdivide_left_tri<Eigen::Lower>(Av);
  EXPECT_DOUBLE_EQ(0.33333333, I(0, 0).val_.val_);
  EXPECT_DOUBLE_EQ(0, I(0, 1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.083333333, I(1, 0).val_.val_);
  EXPECT_DOUBLE_EQ(0.25, I(1, 1).val_.val_);
  EXPECT_DOUBLE_EQ(-0.11111111, I(0, 0).d_.val_);
  EXPECT_DOUBLE_EQ(0, I(0, 1).d_.val_);
  EXPECT_DOUBLE_EQ(-0.034722224, I(1, 0).d_.val_);
  EXPECT_DOUBLE_EQ(-0.0625, I(1, 1).d_.val_);
}
