...
TEST(AgradFwdMatrixOperatorSubtraction, fd_scalar_matrix) {
  ...
  EXPECT_DOUBLE_EQ(1.0, result(0, 0).val_);
  EXPECT_DOUBLE_EQ(0.0, result(0, 1).val_);
  EXPECT_DOUBLE_EQ(-1.0, result(1, 0).val_);
  EXPECT_DOUBLE_EQ(-2.0, result(1, 1).val_);
...
TEST(AgradFwdMatrixOperatorSubtraction, fd_scalar_vector) {
  ...
  result = subtract(2.0, v);
  EXPECT_DOUBLE_EQ(1.0, result(0).val_);
  EXPECT_DOUBLE_EQ(0.0, result(1).val_);
  EXPECT_DOUBLE_EQ(-1.0, result(2).val_);
  EXPECT_DOUBLE_EQ(-2.0, result(3).val_);
...
TEST(AgradFwdMatrixOperatorSubtraction, fd_vector_vector) {
  ...
  EXPECT_DOUBLE_EQ(expected_output(0), output(0).val_);
  EXPECT_DOUBLE_EQ(expected_output(1), output(1).val_);
  EXPECT_DOUBLE_EQ(expected_output(2), output(2).val_);
  EXPECT_DOUBLE_EQ(expected_output(3), output(3).val_);
  EXPECT_DOUBLE_EQ(expected_output(4), output(4).val_);
  EXPECT_DOUBLE_EQ(1, output(0).d_);
  EXPECT_DOUBLE_EQ(1, output(1).d_);
  EXPECT_DOUBLE_EQ(1, output(2).d_);
  EXPECT_DOUBLE_EQ(1, output(3).d_);
  EXPECT_DOUBLE_EQ(1, output(4).d_);
  ...
  EXPECT_DOUBLE_EQ(expected_output(3), output(3).val_);
  EXPECT_DOUBLE_EQ(expected_output(4), output(4).val_);
  EXPECT_DOUBLE_EQ(-1.0, output(0).d_);
  EXPECT_DOUBLE_EQ(-1.0, output(1).d_);
  EXPECT_DOUBLE_EQ(-1.0, output(2).d_);
  EXPECT_DOUBLE_EQ(-1.0, output(3).d_);
  EXPECT_DOUBLE_EQ(-1.0, output(4).d_);
  ...
  EXPECT_DOUBLE_EQ(0, output(3).d_);
  EXPECT_DOUBLE_EQ(0, output(4).d_);
}
...
TEST(AgradFwdMatrixOperatorSubtraction, fd_matrix_matrix) {
  ...
  EXPECT_DOUBLE_EQ(expected_output(0, 0), output(0, 0).val_);
  EXPECT_DOUBLE_EQ(expected_output(0, 1), output(0, 1).val_);
  EXPECT_DOUBLE_EQ(expected_output(1, 0), output(1, 0).val_);
  EXPECT_DOUBLE_EQ(expected_output(1, 1), output(1, 1).val_);
  EXPECT_DOUBLE_EQ(1, output(0, 0).d_);
  EXPECT_DOUBLE_EQ(1, output(0, 1).d_);
  EXPECT_DOUBLE_EQ(1, output(1, 0).d_);
  ...
  EXPECT_DOUBLE_EQ(expected_output(1, 0), output(1, 0).val_);
  EXPECT_DOUBLE_EQ(expected_output(1, 1), output(1, 1).val_);
  EXPECT_DOUBLE_EQ(0, output(0, 0).d_);
