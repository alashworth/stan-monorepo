...
TEST(AgradFwdMatrixDistance, vector_fd_vector_fd) {
  ...
  EXPECT_DOUBLE_EQ(7.071068, a.val_);
  EXPECT_DOUBLE_EQ(0.84852815, a.d_);

  v1.resize(0);
  v2.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(v1, v2).val_);
...
TEST(AgradFwdMatrixDistance, rowvector_fd_vector_fd) {
  ...
  rv.resize(0);
  v.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(rv, v).val_);
...
TEST(AgradFwdMatrixDistance, vector_fd_rowvector_fd) {
  ...
  v.resize(0);
  rv.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(v, rv).val_);
...
TEST(AgradFwdMatrixDistance, vector_ffd_vector_ffd) {
  ...
  EXPECT_DOUBLE_EQ(7.071068, a.val_.val_);
  EXPECT_DOUBLE_EQ(0.84852815, a.d_.val_);

  v1.resize(0);
  v2.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(v1, v2).val_.val_);
...
TEST(AgradFwdMatrixDistance, rowvector_ffd_vector_ffd) {
  ...
  rv.resize(0);
  v.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(rv, v).val_.val_);
...
TEST(AgradFwdMatrixDistance, vector_ffd_rowvector_ffd) {
  ...
  v.resize(0);
  rv.resize(0);
  EXPECT_DOUBLE_EQ(0, stan::math::distance(v, rv).val_.val_);
