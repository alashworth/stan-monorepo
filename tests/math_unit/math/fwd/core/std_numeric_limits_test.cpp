...
TEST(AgradFwdNumericLimits, All_Fvar) {
  ...
  EXPECT_DOUBLE_EQ(53, std::numeric_limits<fvar<double> >::digits);
  EXPECT_DOUBLE_EQ(53, std::numeric_limits<fvar<fvar<double> > >::digits);
  ...
  EXPECT_DOUBLE_EQ(2, std::numeric_limits<fvar<double> >::radix);
  EXPECT_DOUBLE_EQ(2, std::numeric_limits<fvar<fvar<double> > >::radix);
  ...
  EXPECT_DOUBLE_EQ(0.5, std::numeric_limits<fvar<double> >::round_error().val_);
  EXPECT_DOUBLE_EQ(
      0.5, std::numeric_limits<fvar<fvar<double> > >::round_error().val_.val_);

  EXPECT_DOUBLE_EQ(-1021, std::numeric_limits<fvar<double> >::min_exponent);
  EXPECT_DOUBLE_EQ(-1021,
                   std::numeric_limits<fvar<fvar<double> > >::min_exponent);

  EXPECT_DOUBLE_EQ(-307, std::numeric_limits<fvar<double> >::min_exponent10);
  EXPECT_DOUBLE_EQ(-307,
                   std::numeric_limits<fvar<fvar<double> > >::min_exponent10);

  EXPECT_DOUBLE_EQ(1024, std::numeric_limits<fvar<double> >::max_exponent);
  EXPECT_DOUBLE_EQ(1024,
                   std::numeric_limits<fvar<fvar<double> > >::max_exponent);

  EXPECT_DOUBLE_EQ(308, std::numeric_limits<fvar<double> >::max_exponent10);
  EXPECT_DOUBLE_EQ(308,
  ...
  EXPECT_DOUBLE_EQ(INFTY, std::numeric_limits<fvar<double> >::infinity().val_);
  EXPECT_DOUBLE_EQ(
