...
std::vector<std::string> create_search_path() {
  ...
  search_path.emplace_back("foo");
  search_path.emplace_back("../test-models/included/");
  search_path.emplace_back("bar/baz");
  search_path.emplace_back("../../../tests/test_models/included");
  return search_path;
}
