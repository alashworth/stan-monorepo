...
class StanIoStanCsvReader : public testing::Test {
 public:
  void SetUp() {
    adaptation1_stream.open("io/test_csv_files/adaptation1.csv");
    blocker0_stream.open("io/test_csv_files/blocker.0.csv");
    eight_schools_stream.open("io/test_csv_files/eight_schools.csv");
    header1_stream.open("io/test_csv_files/header1.csv");
    metadata1_stream.open("io/test_csv_files/metadata1.csv");
    metadata3_stream.open("io/test_csv_files/metadata3.csv");
    samples1_stream.open("io/test_csv_files/samples1.csv");

    ASSERT_FALSE(!adaptation1_stream);
    ASSERT_FALSE(!blocker0_stream);
    ASSERT_FALSE(!eight_schools_stream);
    ASSERT_FALSE(!header1_stream);
    ASSERT_FALSE(!metadata1_stream);
    ASSERT_FALSE(!metadata3_stream);
    ASSERT_FALSE(!samples1_stream);
  }

  void TearDown() {
    adaptation1_stream.close();
    blocker0_stream.close();
    eight_schools_stream.close();
