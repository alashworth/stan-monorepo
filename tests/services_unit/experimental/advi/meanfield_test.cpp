...
class ServicesExperimentalAdviMeanfield : public testing::Test {
public:
  ServicesExperimentalAdviMeanfield()
...
TEST_F(ServicesExperimentalAdviMeanfield, experimental_message) {
  unsigned int seed = 0;
...
TEST_F(ServicesExperimentalAdviMeanfield, meanfield) {
  unsigned int seed = 0;
  unsigned int chain = 1;
  double init_radius = 0;
  int grad_samples = 1;
