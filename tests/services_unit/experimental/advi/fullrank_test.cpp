...
class ServicesExperimentalAdviFullRank : public testing::Test {
public:
  ServicesExperimentalAdviFullRank()
...
TEST_F(ServicesExperimentalAdviFullRank, experimental_message) {
  unsigned int seed = 0;
...
TEST_F(ServicesExperimentalAdviFullRank, fullrank) {
  unsigned int seed = 0;
  unsigned int chain = 1;
  double init_radius = 0;
  int grad_samples = 1;
