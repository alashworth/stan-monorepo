#include "variational/models/univariate_no_constraint.hpp"
...
class advi_test_f : public ::testing::Test {
public:
  advi_test_f()
...
TEST_F(advi_test_f, max_iteration_warn_meanfield) {
...
TEST_F(advi_test_f, max_iteration_warn_fullrank) {
...
TEST_F(advi_test_f, prev_elbo_larger_meanfield) {
...
TEST_F(advi_test_f, prev_elbo_larger_fullrank) {
