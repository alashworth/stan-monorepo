#include "variational/models/gradient_warn.hpp"
...
class advi_test_g : public ::testing::Test {
public:
  advi_test_g()
  ...
  void SetUp() {
    std::fstream data_stream("variational/models/gradient_warn.data.R",
                             std::fstream::in);
    ASSERT_FALSE(!data_stream);
...
TEST_F(advi_test_g, gradient_warn_meanfield) {
...
TEST_F(advi_test_g, gradient_warn_fullrank) {
