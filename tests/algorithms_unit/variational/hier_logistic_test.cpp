#include "variational/models/hier_logistic.hpp"
...
class advi_test_hier : public ::testing::Test {
public:
  advi_test_hier()
  ...
  void SetUp() {
    ...
    std::fstream data_stream("variational/models/hier_logistic.data.R",
                             std::fstream::in);
...
TEST_F(advi_test_hier, hier_logistic_constraint_meanfield) {
